...
#### 2. The deployment should auto scale at average 50% CPU and 60% memory.(incompleted)
#### 3. Load test the application (can be done using JMeter) and include the test results in your submission.(incompleted)
